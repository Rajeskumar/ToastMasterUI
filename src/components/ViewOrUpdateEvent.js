...
class ViewOrUpdateEvent extends React.Component{

    constructor(props){
        super(props)
        this.state = {
            todayDate:"2019-01-01",
            eventRequest:this.props.selectedEvent,
            openDialog : this.props.openViewDialog,
        }
    }

      submitUpdateRequest = () => {
        // console.log('Update Event Submitted :',this.state.eventRequest);
        ...
        axios.post('http://localhost:8080/toastmasterapi/toastMaster/updateEvent', eventRequest)
        .then(res => {
    ...
    render(){    
        ...
        return(
            <div>
                <Dialog
                    title="View or Update Toastmaster Event"
                    modal={true}
                    open={this.state.openDialog}
                    onClose={this.props.handleDialogClose}
                    aria-labelledby="form-dialog-title"
                    >
                    <DialogTitle id="form-dialog-title">View or Update Toastmaster Event</DialogTitle>
                    <DialogContent>
                        <DialogContentText>
                            View or Update the selected Event
                        </DialogContentText>
...
ViewOrUpdateEvent.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(ViewOrUpdateEvent);